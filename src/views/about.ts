export function aboutView(siteName: string): string {
  ...
  <section class="section wrap prose">
    <p>${siteName} started as a simple idea: the best product finds happen mid-scroll, on Instagram or YouTube, but tracking down the exact link afterwards is a pain — dead links, "swipe up" that doesn't work, comments full of "link please?". We wanted a place where a short code does that job instead.</p>
